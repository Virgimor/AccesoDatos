...
import es.iesjandula.examen_ud2.repository.HistorialPuestosRepository;
...
//	public Page<String> obtenerDiferenciaDeSalariosEntreElPuestoActualYElPrimerPuestoOcupado(@PageableDefault(size=10) Pageable pageable){
//		
//		return this.empleadosRepository.mostrarGerentesCuyosEmpleadosTienenElSalarioMaximoDeLaEmpresa(pageable);
//		
//	}
