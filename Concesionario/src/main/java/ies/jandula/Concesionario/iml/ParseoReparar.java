...
scanner.nextLine();
		...
		while(scanner.hasNextLine()) {
			...
			RepararId repararId = new RepararId(matriculaCoche, dniMecanico, fechaReparacion);
			
			//repararId.setDniMecanico(dniMecanico);
			//repararId.setMatriculaCoche(matriculaCoche);
